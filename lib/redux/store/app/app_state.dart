...
class AppState {
  ...
  const AppState({required this.authState, required this.detailsState, required this.bottomNavState});

  factory AppState.initial() => AppState(authState: AuthState.initial(), detailsState: DetailsState.initial(), bottomNavState: BottomNavState.initial());
